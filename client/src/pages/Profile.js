...
const Profile = () => {
  ...
  if (!Auth.loggedIn()) {
    return (
      <Heading as="h4" mt={40} textAlign="center">
      ...
      <Grid templateColumns="repeat(12, 1fr)" gap={2}>
        ...
        <GridItem colSpan={{ base: 12, md: 6, lg: 4 }}>
          ...
          <Card mt={{ base: 4, md: 10 }}>
            <CardBody>
              <Heading as="h3" fontSize="2xl" mt={3} mb={2}>
                User Info:
              </Heading>
        ...
        <GridItem colSpan={{ base: 12, md: 4 }}>
          ...
          <Box mt={{ base: 4, md: 10 }} mx={{ base: 0, md: 3, lg: 10 }}>
            <Heading as="h3" fontSize="2xl" mt={3}>
              Bookings:
            </Heading>
            ...
            <Card mt={6}>
              <CardBody>
                {/* Boat Name */}
                <Heading as="h3" textAlign="center" fontSize="xl" mt={3}>
                  Splashy McBoat
                </Heading>
                ...
                {/* ADD --> Boat Image */}
                <Image src="/images/boat2.jpg" alt="a boat" mt={6} />
                ...
                {/* Cancel Reservation */}
                <Button fontSize="lg" colorScheme="red" mt={4} w="full">
                  Cancel Reservation
                </Button>
              </CardBody>
            </Card>
